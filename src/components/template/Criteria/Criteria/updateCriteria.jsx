      ...
      <div className="modal-dialog">
        <form onSubmit={submitUpdateCriteria} className="modal-content">
          <div className="modal-header">
            <h1 className="modal-title fs-5" id="exampleModalLabel">Update Criteria</h1>
            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div className="modal-body">
            <input type='text' name='title' className="form-control" placeholder="Nama Criteria" defaultValue={title}/>
          </div>
